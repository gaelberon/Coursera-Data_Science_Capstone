...
```{r text_prediction_create_and_store_ngrams, cache = TRUE}
quadrigrams <- build_prediction_from_ngrams(ngrams = train4Gram)
#print(head(quadrigrams))
# Save dataframe 'quadrigrams' to rda file
save(quadrigrams, file = "quadrigrams.rda")

trigrams <- build_prediction_from_ngrams(ngrams = train3Gram)
#print(head(trigrams))
# Save dataframe 'trigrams' to rda file
save(trigrams, file = "trigrams.rda")

bigrams <- build_prediction_from_ngrams(ngrams = train2Gram)
#print(head(bigrams))
